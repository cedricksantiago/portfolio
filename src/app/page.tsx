...
export default function Home() {
  return (
    <>
      ...
      >
        <div className="flex items-center gap-6 px-6 py-3 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl">
          <Link href="#about" className="text-sm font-medium text-white/70 hover:text-white transition-colors">About</Link>
          <Link href="#works" className="text-sm font-medium text-white/70 hover:text-white transition-colors">Works</Link>
      ...
      <section className="min-h-[75vh] flex flex-col justify-center w-full mb-20">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <h2 className="text-violet-400 font-medium mb-4 tracking-widest uppercase text-sm">Hello World</h2>
          ...
          <div className="flex gap-6 items-center">
            <Magnetic>
              <button className="interactive px-8 py-4 bg-white text-black font-bold rounded-full shadow-[0_0_20px_rgba(138,43,226,0.3)] hover:shadow-[0_0_30px_rgba(138,43,226,0.8)] transition-shadow flex items-center gap-2">
                View CV
              </button>
            </Magnetic>
            <Magnetic>
              <Link href="https://github.com/Garou0727" target="_blank" className="interactive p-4 bg-white/5 border border-white/10 hover:border-violet-500/50 hover:bg-violet-600/20 rounded-full transition-colors flex items-center justify-center">
      ...
      <section id="contact" className="w-full py-32 mb-20 scroll-mt-20">
        ...
        >
          <div className="absolute inset-0 bg-violet-600/5 blur-[100px] rounded-full pointer-events-none"></div>
          <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-violet-500/50 to-transparent"></div>
          <h3 className="text-5xl md:text-6xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-violet-500 tracking-tight">Let's build something.</h3>
          ...
          <Magnetic>
            <Link
              ...
              className="interactive group px-10 py-5 bg-white text-black font-bold text-lg rounded-full flex items-center gap-3 shadow-[0_0_30px_rgba(138,43,226,0.3)] hover:shadow-[0_0_60px_rgba(138,43,226,0.8)] transition-shadow"
            >
